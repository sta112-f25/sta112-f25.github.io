...
![](sprinting_bbc_screenshot.png)

---

### Sprinting performance

![](sprinting_extrapolation_graph.png)
...
* Assumes the observed relationship extends to a different population
* This assumption can lead to nonsensical predictions
* By definition, we can't examine the relationship outside the range of observed data!
]
