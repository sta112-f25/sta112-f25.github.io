...
**Important:** This assignment is *optional*. I will take your 6 highest hw grades in the class; so, if you choose to complete this assignment, it can potentially replace one of your other hw grades.

# Setup

1. Download the Quarto template file for this assignment: [hw_07_template.qmd](https://sta112-f25.github.io/homework/hw_07_template.qmd). Save it to your computer, and change the file name to `hw_07_your_name.qmd`
2. Open `hw_07_your_name.qmd` in RStudio. Change the `author` in YAML to your name.
...
4. When you are done, render and submit your HTML file on Canvas (Assignments -> Homework 7).
