...
1. Download the Quarto template file for this assignment: [hw_03_template.qmd](https://sta112-f25.github.io/homework/hw_03_template.qmd). Save it to your computer, and change the file name to `hw_03_your_name.qmd`
...
Based on our discussion from class on September 19, interpret the estimated coefficient $\widehat{\beta}_1$ in context of the data.
:::

:::{.question}
#### Question 7

Make a residual plot for the fitted model in Question 5, and assess the shape and constant variance assumptions.
:::
